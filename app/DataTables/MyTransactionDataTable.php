...
class MyTransactionDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'my_transaction.datatables_actions');
    }
    ...
    {
        return $model->newQuery()->where('shop_id', Auth::user()->id);
    }
    ...
    {
        return 'mytransactiondatatable_' . time();
    }
}
